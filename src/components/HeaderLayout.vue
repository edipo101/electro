                                    ...
                                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                        <ul class="navbar-nav u-header__navbar-nav">
                                            ...
                                            <li class="nav-item hs-has-sub-menu u-header__nav-item"
                                                ...
                                                <router-link id="HomeMegaMenu" class="nav-link u-header__nav-link u-header__nav-link-toggle" :to="{name: 'home-page'}" aria-haspopup="true" aria-expanded="false" aria-labelledby="HomeSubMenu">Home</router-link>
