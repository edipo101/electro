                            ...
                            <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--no-space">
                                ...
                                <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        ...
                                        <!-- Featured Brands -->
                                        <li class="nav-item u-header__nav-item">
                                            <router-link class="nav-link u-header__nav-link" :to="{name: 'shop-grid'}" aria-haspopup="true" aria-expanded="false" aria-labelledby="pagesSubMenu">Featured Brands</router-link><!-- <a class="nav-link u-header__nav-link" href="./shop-grid.html" aria-haspopup="true" aria-expanded="false" aria-labelledby="pagesSubMenu">Featured Brands</a> -->
                                        </li>
                                        <!-- End Featured Brands -->
